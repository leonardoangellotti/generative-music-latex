...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{/Users/leonardoangellotti/Desktop/tesi latex/immagini/markov2} 
    \caption{Descrizione dell'immagine}
    \label{fig:immagine}
\end{figure}
...
\subsectioni{Caratteristiche di una Nota Musicale}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{/Users/leonardoangellotti/Desktop/tesi latex/immagini/dynamics} 
    \caption{Descrizione dell'immagine}
    \label{fig:immagine}
\end{figure}
