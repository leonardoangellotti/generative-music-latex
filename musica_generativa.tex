...
% Inizio della tesi vera e propria
\chapter*{Capitolo 1}
\section*{Introduzione}
% Qui inizia il testo della tesi
...
% Qui inizia il testo del terzo capitolo
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{/Users/leonardoangellotti/Desktop/tesi latex/immagini/immagine1} % Sostituisci con il percorso al file della tua immagine
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{/Users/leonardoangellotti/Desktop/tesi latex/immagini/immagine2} % Sostituisci con il percorso al file della tua immagine
    \caption{Descrizione dell'immagine}
    \label{fig:immagine}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{/Users/leonardoangellotti/Desktop/tesi latex/immagini/immagine3} % Sostituisci con il percorso al file della tua immagine
    \caption{Descrizione dell'immagine}
    \label{fig:immagine}
\end{figure}
